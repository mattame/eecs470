...
#<Session mode="Full" path="/afs/umich.edu/user/s/c/scottmel/EECS470/FinalProject/eecs470/vsimp_new/DVEfiles/crash_04.21:20.20/dve_session04.21:20.20.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{217 144} {1608 1058}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 202} {height 651} {dock_state left} {dock_on_new_line true} {child_hier_colhier 202} {child_hier_coltype 88} {child_hier_col1 0} {child_hier_col2 1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 654]
set Data.1 [gui_share_window -id ${DLPane.1} -type Data]
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 654
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 651
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 653} {height 651} {dock_state left} {dock_on_new_line true} {child_data_colvariable 318} {child_data_colvalue 205} {child_data_coltype 191} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 165]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1392
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 165
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1391} {height 164} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{10 51} {1866 1167}}
