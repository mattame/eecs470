...
# DVE full session
# Saved on Fri Apr 19 03:21:58 2013
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{531 156} {1780 1170}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 240]
set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier]
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 240
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value -1
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 239} {height 718} {dock_state left} {dock_on_new_line true} {child_hier_colhier 218} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 483} {height 718} {dock_state left} {dock_on_new_line true} {child_data_colvariable 236} {child_data_colvalue 126} {child_data_coltype 116} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 175]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1250
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 175
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1249} {height 174} {dock_state bottom} {dock_on_new_line true}}
