...
# DVE full session
# Saved on Fri Apr 19 23:01:16 2013
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{619 187} {1837 1170}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 208} {height 717} {dock_state left} {dock_on_new_line true} {child_hier_colhier 218} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 452} {height 717} {dock_state left} {dock_on_new_line true} {child_data_colvariable 236} {child_data_colvalue 126} {child_data_coltype 116} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 144]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1219
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 144
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1218} {height 143} {dock_state bottom} {dock_on_new_line true}}
