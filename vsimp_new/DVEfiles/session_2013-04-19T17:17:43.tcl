...
# DVE full session
# Saved on Fri Apr 19 17:17:43 2013
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{52 101} {1917 1170}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 232} {height 823} {dock_state left} {dock_on_new_line true} {child_hier_colhier 202} {child_hier_coltype 88} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 683} {height 823} {dock_state left} {dock_on_new_line true} {child_data_colvariable 318} {child_data_colvalue 205} {child_data_coltype 191} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1865} {height 147} {dock_state bottom} {dock_on_new_line true}}
...
catch {gui_list_select -id ${Hier.1} {testbench.pipeline_0.reservation_station_0}}
...
gui_list_show_data -id ${Data.1} {testbench.pipeline_0.reservation_station_0}
