...
# DVE full session
# Saved on Fri Apr 19 01:05:48 2013
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{86 146} {1747 1170}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 276} {height 776} {dock_state left} {dock_on_new_line true} {child_hier_colhier 201} {child_hier_coltype 107} {child_hier_col1 0} {child_hier_col2 1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 529]
set Data.1 [gui_share_window -id ${DLPane.1} -type Data]
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 529
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 776
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 528} {height 776} {dock_state left} {dock_on_new_line true} {child_data_colvariable 233} {child_data_colvalue 186} {child_data_coltype 117} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 150]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1662
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 150
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1661} {height 149} {dock_state bottom} {dock_on_new_line true}}
