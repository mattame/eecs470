...
# DVE full session
# Saved on Sun Apr 21 22:33:37 2013
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{65 58} {1917 1170}}
...
gui_sg_addsignal -group ${Group2} { testbench.pipeline_0.register_file0.values }
set Group3 Group3
gui_sg_create ${Group3}
gui_sg_addsignal -group ${Group3} { testbench.pipeline_0.reorder_buffer_0.inst1_NPC_out testbench.pipeline_0.reorder_buffer_0.inst1_branch_result_out testbench.pipeline_0.reorder_buffer_0.inst1_dest_out testbench.pipeline_0.reorder_buffer_0.inst1_mispredicted_out testbench.pipeline_0.reorder_buffer_0.inst1_pht_index_out testbench.pipeline_0.reorder_buffer_0.inst1_retire_tag_out testbench.pipeline_0.reorder_buffer_0.inst1_value_out testbench.pipeline_0.reorder_buffer_0.inst2_NPC_out testbench.pipeline_0.reorder_buffer_0.inst2_branch_result_out testbench.pipeline_0.reorder_buffer_0.inst2_dest_out testbench.pipeline_0.reorder_buffer_0.inst2_mispredicted_out testbench.pipeline_0.reorder_buffer_0.inst2_pht_index_out testbench.pipeline_0.reorder_buffer_0.inst2_retire_tag_out testbench.pipeline_0.reorder_buffer_0.inst2_value_out }
...
gui_wv_zoom_timerange -id ${Wave.1} 128 558
...
gui_list_select -id ${Wave.1} {testbench.pipeline_0.reorder_buffer_0.inst1_value_out }
...
gui_marker_move -id ${Wave.1} {C1} 496
gui_view_scroll -id ${Wave.1} -vertical -set 721
