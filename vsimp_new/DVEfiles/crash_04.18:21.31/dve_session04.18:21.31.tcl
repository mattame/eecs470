...
# DVE full session
# Saved on Thu Apr 18 21:31:50 2013
# Designs open: 1
...
#<Session mode="Full" path="/afs/umich.edu/user/m/a/mattnick/eecs470/P4/eecs470/vsimp_new/DVEfiles/crash_04.18:21.31/dve_session04.18:21.31.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{34 120} {1721 1170}}
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 302]
set Hier.1 [gui_share_window -id ${HSPane.1} -type Hier]
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 302
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value -1
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 301} {height 777} {dock_state left} {dock_on_new_line true} {child_hier_colhier 201} {child_hier_coltype 107} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 777
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 328} {height 777} {dock_state left} {dock_on_new_line true} {child_data_colvariable 192} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1687} {height 174} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{251 218} {1871 1170}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 470} {child_wave_right 1145} {child_wave_colname 233} {child_wave_colvalue 233} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sg_addsignal -group ${Group1} { testbench.pipeline_error_status testbench.clock testbench.reset testbench.pipeline_0.halted }
...
catch { gui_list_select -id ${Data.1} {testbench.pipeline_0.halted }}
gui_view_scroll -id ${Data.1} -vertical -set 2229
...
gui_open_source -id ${Source.1}  -replace -active branch_decoder /afs/umich.edu/user/m/a/mattnick/eecs470/P4/eecs470/vsimp_new/verilog/branch_predictor.v
...
gui_wv_zoom_timerange -id ${Wave.1} 0 375
...
gui_marker_move -id ${Wave.1} {C1} 342
