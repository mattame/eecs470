...
# DVE full session
# Saved on Fri Apr 19 00:51:25 2013
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{82 144} {1745 1170}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 278} {height 776} {dock_state left} {dock_on_new_line true} {child_hier_colhier 201} {child_hier_coltype 107} {child_hier_col1 0} {child_hier_col2 1}}
set DLPane.1 [gui_create_window -type DLPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 531]
set Data.1 [gui_share_window -id ${DLPane.1} -type Data]
gui_set_window_pref_key -window ${DLPane.1} -key dock_width -value_type integer -value 531
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 776
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 530} {height 776} {dock_state left} {dock_on_new_line true} {child_data_colvariable 233} {child_data_colvalue 186} {child_data_coltype 117} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 152]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1664
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 152
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1663} {height 151} {dock_state bottom} {dock_on_new_line true}}
...
gui_sim_run Ucli -exe dve_simv -args {-ucligui } -dir /afs/umich.edu/user/m/a/mattnick/eecs470/P4/eecs470/vsimp_new -nosource
}
}
