...
# DVE full session
# Saved on Fri Apr 19 16:56:58 2013
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{2 51} {1197 750}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 232} {height 397} {dock_state left} {dock_on_new_line true} {child_hier_colhier 202} {child_hier_coltype 88} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 700
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 222} {height 397} {dock_state left} {dock_on_new_line true} {child_data_colvariable 101} {child_data_colvalue 89} {child_data_coltype 10} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${DriverLoad.1} {{left 0} {top 0} {width 923} {height 179} {dock_state bottom} {dock_on_new_line false}}
...
gui_sg_addsignal -group ${Group1} { testbench.pipeline_0.LSQ_0.next_entry_2 }
set Group2 Group2
gui_sg_create ${Group2}
gui_sg_addsignal -group ${Group2} { testbench.pipeline_0.LSQ_0.clock testbench.pipeline_0.LSQ_0.reset testbench.pipeline_0.LSQ_0.Dmem2proc_data testbench.pipeline_0.LSQ_0.Dmem2proc_tag testbench.pipeline_0.LSQ_0.Dmem2proc_response testbench.pipeline_0.LSQ_0.proc2Dmem_command testbench.pipeline_0.LSQ_0.proc2Dmem_addr testbench.pipeline_0.LSQ_0.proc2Dmem_data }
set Group3 Group3
gui_sg_create ${Group3}
gui_sg_addsignal -group ${Group3} { testbench.memory.valid_address }
set Group4 Group4
gui_sg_create ${Group4}
gui_sg_addsignal -group ${Group4} { testbench.memory.proc2mem_addr testbench.memory.proc2mem_data testbench.memory.proc2mem_command testbench.memory.mem2proc_response testbench.memory.mem2proc_data testbench.memory.mem2proc_tag }
...
catch { gui_list_select -id ${Data.1} {testbench.memory.mem2proc_response testbench.memory.mem2proc_tag testbench.memory.mem2proc_data testbench.memory.proc2mem_data testbench.memory.proc2mem_command testbench.memory.proc2mem_addr }}
...
gui_view_scroll -id ${Source.1} -vertical -set 645
gui_src_set_reusable -id ${Source.1}

# DriverLoad 'DriverLoad.1'
gui_get_drivers -session -id ${DriverLoad.1} -signal testbench.memory.valid_address -time 990662
