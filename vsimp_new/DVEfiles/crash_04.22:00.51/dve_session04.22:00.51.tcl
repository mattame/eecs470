...
# DVE full session
# Saved on Mon Apr 22 00:51:19 2013
# Designs open: 1
...
#<Session mode="Full" path="/afs/umich.edu/user/s/c/scottmel/EECS470/FinalProject/eecs470/vsimp_new/DVEfiles/crash_04.22:00.51/dve_session04.22:00.51.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{67 60} {1917 1170}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 536} {child_wave_right 1309} {child_wave_colname 266} {child_wave_colvalue 266} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sim_run Ucli -exe dve_simv -args {-ucligui +v2k +vc +memcbk} -dir /afs/umich.edu/user/s/c/scottmel/EECS470/FinalProject/eecs470/vsimp_new -nosource
}
}
...
gui_sg_addsignal -group ${Group1} { testbench.pipeline_0.register_file0.values }
set Group2 Group2
gui_sg_create ${Group2}
gui_sg_addsignal -group ${Group2} { testbench.pipeline_0.reorder_buffer_0.inst1_rega_value_out testbench.pipeline_0.reorder_buffer_0.inst1_regb_value_out testbench.pipeline_0.reorder_buffer_0.inst1_dest_out testbench.pipeline_0.reorder_buffer_0.inst1_value_out testbench.pipeline_0.reorder_buffer_0.inst1_retire_tag_out testbench.pipeline_0.reorder_buffer_0.inst1_mispredicted_out testbench.pipeline_0.reorder_buffer_0.inst1_branch_result_out testbench.pipeline_0.reorder_buffer_0.inst1_NPC_out testbench.pipeline_0.reorder_buffer_0.inst1_pht_index_out testbench.pipeline_0.reorder_buffer_0.inst1_CPC_out }
set Group3 Group3
gui_sg_create ${Group3}
gui_sg_addsignal -group ${Group3} { testbench.pipeline_0.reorder_buffer_0.inst2_tag_out testbench.pipeline_0.reorder_buffer_0.inst2_rega_value_out testbench.pipeline_0.reorder_buffer_0.inst2_regb_value_out testbench.pipeline_0.reorder_buffer_0.inst2_dest_out testbench.pipeline_0.reorder_buffer_0.inst2_value_out testbench.pipeline_0.reorder_buffer_0.inst2_retire_tag_out testbench.pipeline_0.reorder_buffer_0.inst2_mispredicted_out testbench.pipeline_0.reorder_buffer_0.inst2_branch_result_out testbench.pipeline_0.reorder_buffer_0.inst2_NPC_out testbench.pipeline_0.reorder_buffer_0.inst2_pht_index_out testbench.pipeline_0.reorder_buffer_0.inst2_CPC_out }
set Group4 Group4
gui_sg_create ${Group4}
gui_sg_addsignal -group ${Group4} { testbench.pipeline_0.if_stage_0.PC_reg }
set Group5 Group5
gui_sg_create ${Group5}
gui_sg_addsignal -group ${Group5} { testbench.pipeline_0.stall_bus_1 testbench.pipeline_0.stall_bus_2 testbench.pipeline_0.if_stage_stall_signal testbench.pipeline_0.stall_first_half_of_pipeline }
set Group6 Group6
gui_sg_create ${Group6}
gui_sg_addsignal -group ${Group6} { testbench.pipeline_0.proc2Dmem_addr testbench.pipeline_0.lsq_Dmem2proc_tag testbench.pipeline_0.lsq_Dmem2proc_data testbench.pipeline_0.proc2Dmem_command testbench.pipeline_0.lsq_proc2Dmem_addr_out testbench.pipeline_0.lsq_proc2Dmem_command_out testbench.pipeline_0.lsq_Dmem2proc_response testbench.pipeline_0.lsq_proc2Dmem_data_out testbench.pipeline_0.Dmem2proc_response }
...
catch { gui_list_select -id ${Data.1} {testbench.pipeline_0.proc2Dmem_addr testbench.pipeline_0.lsq_Dmem2proc_tag testbench.pipeline_0.lsq_Dmem2proc_data testbench.pipeline_0.proc2Dmem_command testbench.pipeline_0.lsq_proc2Dmem_addr_out testbench.pipeline_0.lsq_proc2Dmem_command_out testbench.pipeline_0.lsq_Dmem2proc_response testbench.pipeline_0.lsq_proc2Dmem_data_out testbench.pipeline_0.Dmem2proc_response }}
...
gui_open_source -id ${Source.1}  -replace -active testbench.pipeline_0 /afs/umich.edu/user/s/c/scottmel/EECS470/FinalProject/eecs470/vsimp_new/verilog/pipeline.v
...
gui_wv_zoom_timerange -id ${Wave.1} 0 1761
...
gui_list_select -id ${Wave.1} {testbench.pipeline_0.reorder_buffer_0.inst1_CPC_out }
...
gui_marker_move -id ${Wave.1} {C1} 656
gui_view_scroll -id ${Wave.1} -vertical -set 723
